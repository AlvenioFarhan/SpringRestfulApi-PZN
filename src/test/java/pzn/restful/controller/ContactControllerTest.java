...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        ...
        request.setLastName("Farhan");
        request.setEmail("alvenio@example.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("Alvenio", response.getData().getFirstName());
            assertEquals("Farhan", response.getData().getLastName());
            assertEquals("alvenio@example.com", response.getData().getEmail());
    ...
    void getContactSuccess() throws Exception {
        ...
        contact.setFirstName("Alvenio");
        contact.setLastName("Farhan");
        contact.setEmail("alvenio@example.com");
    ...
    void searchSuccess() throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            contact.setId(UUID.randomUUID().toString());
            contact.setUser(user);
            contact.setFirstName("Alvenio " + i);
            contact.setLastName("Farhan");
            contact.setEmail("alvenio@example.com");
            contact.setPhone("9238423432");
            contactRepository.save(contact);
